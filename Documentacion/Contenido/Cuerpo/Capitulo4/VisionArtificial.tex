...
\end{center}
En la figura 4.13 se aprecia la separación de la figura 4.12 en 4 colores; Rojo, Amarillo, Verde y Azul.
...
\begin{center}
	...
	\captionof{figure}{Corrección de gamma, la imagen de la derecha es la corregida}\label{Fig9}
\end{center}
