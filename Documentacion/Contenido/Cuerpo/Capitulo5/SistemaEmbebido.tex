...
La conexiones eléctricas se ilustra en la figura 5.8. Es una esquemático que muestra la conexión entre los componentes principales: la cámara(OCAM), monoprocesador(ODROID),
