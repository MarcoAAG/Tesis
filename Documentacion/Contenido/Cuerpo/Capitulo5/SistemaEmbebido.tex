...
\begin{center}
	...
	\captionof{figure}{Grafica del error en Pitch con ganancia Kp = 0.62}\label{Fig4}
\end{center}
...
servomotor y la retroalimentación en la camara como se observa en la figura 5.21
\begin{center}
