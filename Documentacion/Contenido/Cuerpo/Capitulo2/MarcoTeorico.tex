...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.9 \textwidth]{Contenido/Cuerpo/Capitulo2/Fig20.eps}
...
\end{center}
De la figura 2.23 se puede observar como en (b) el proceso de erosión disminuye la dimensión de las figuras, y en algunos casos elimina la totalidad de estos.
...
\end{equation}
La figura 2.24 ilustra el resultado de aplicar la operación de dilatación de donde el elemnto estructurante Y tiene forma de disco.
\begin{center}
...
integral doble sobre una región plana D con límites C, tal como se ilustra en la figura 2.27.
\begin{center}
...
\begin{center}
	...
	\label{fig:MarcoTeorico:Fig25}
\end{center}
La figura 2.28 muestra un sistema de control en su forma más simple, donde la entrada representa
una salida deseada.\\
...
en la figura 2.29 y la respuesta del sistema se ilustra con la curva azul.
\begin{center}
