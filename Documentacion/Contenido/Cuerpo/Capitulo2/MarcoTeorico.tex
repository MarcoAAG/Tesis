...
% NUEVA SUBSECCION
% ----------------------------------------------------------------------------------------------------------------------------
\subsection{Componentes de la cámara}
\begin{itemize}
...
La figura 2.12 ilustra la proyección del punto \textbf{X} de ${\textbf{I\!R}^3}$ al punto \text{x}
de ${\textbf{I\!R}^2}$
\begin{center}
...
\begin{center}
	...
	\captionof{figure}{Respuesta de un Sistema de Primer orden a un escalón unitario, tomada de \cite{Book:Nise2010}}
	\label{fig:MarcoTeorico:Fig25}
\end{center}
\begin{itemize}
